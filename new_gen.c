...
int main(int argc, char * argv[])
{
    ...
    else if (pidScheduler == 0)
    {
            ...
            printf("%s\t%s", algorithm, quantumStr);
            char* args[] = {"/home/ziad/Project/Ours/OS-Hero/scheduler", algorithm, quantumStr, NULL};
            execvp(args[0], args);
    ...
    else
    {
        ...
        {
            printf("Hello");
            char * args[] = {"/home/ziad/Project/Ours/OS-Hero/clk", NULL};
            execvp(args[0], args);
            printf("Error in fork");
        }
    }
